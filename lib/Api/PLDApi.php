...
class PLDApi
{
    ...
    public function getPLDAsync($x_api_key, $username, $password, $x_signature, $body)
    {
        return $this->getPLDAsyncWithHttpInfo($x_api_key, $username, $password, $x_signature, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
