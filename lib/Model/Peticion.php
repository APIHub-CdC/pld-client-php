...
class Peticion implements ModelInterface, ArrayAccess
{
    ...
    public function setApellidoPaterno($apellido_paterno)
    {
        if ((mb_strlen($apellido_paterno) > 30)) {
            throw new \InvalidArgumentException('invalid length for $apellido_paterno when calling Peticion., must be smaller than or equal to 30.');
        }
    ...
    public function setApellidoMaterno($apellido_materno)
    {
        if ((mb_strlen($apellido_materno) > 30)) {
            throw new \InvalidArgumentException('invalid length for $apellido_materno when calling Peticion., must be smaller than or equal to 30.');
        }
